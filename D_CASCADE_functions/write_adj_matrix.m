...
%write_adj_matrix function takes a two vectors of from-nodes and to-nodes transfers them into a (sparse) adjacency matrix . Each pair of from-nodes and to-nodes
